...
public class Run {
  ...
  public static void main(String[] args) {
    File file = new File("trillo_config.json");
    if (!file.exists()) {
     ...
     */
    //executeFunction("DSAPISample", null);
    //executeFunction("ParameterSample", "./input_files/ParameterSampleInput.json");
    //executeFunction("DataIteratorSample", null);
    //executeFunction("SaveRecord", null);
    //executeFunction("FileCopyToBucket", null);
    //executeFunction("CICSBlueEHRImport", "./input_files/CICSBlueEHRImport.json");
    //executeFunction("CreateRetryTasks", null);
    //executeFunction("LoadOrders", null);
    //executeFunction("GMCInventoryFeed", "./input_files/GMCInventoryFeed.json");
    //executeFunction("StoredProcedureDemo", null);
    //executeFunction("StoredProcedureWithParemterDemo", null);
    //executeFunction("ObjectDetection", "./input_files/ObjectDetection.json");
    //executeFunction("ExtractText", "./input_files/ExtractText.json");
    //executeFunction("EmpImport", null);
    executeFunction("DDMNetRevenue", "./input_files/DDMNetRevenue.json");
    log.info("Done");
  }
