 ...
 */
public class RetrieveByQuery implements Loggable, TrilloFunction {
    ...
    private Object _handle(ScriptParameter params) {
        String qry="Select first_name from mydb_tbl where test_id=10";
        //return DSApi.queryOne("mydb", "qry", true);
        return DSApi.queryOne(qry);
