 ...
 */
public class QueryOne implements Loggable, TrilloFunction {
    ...
    private Object _handle(ScriptParameter params) {
        String sqlQuery = "Select * from ComputerInfo_tbl where maker = \"AsusSTRIX\" & id=7 ";

        return DSApi.queryOne(sqlQuery);
