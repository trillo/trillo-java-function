...
public class RTContext {
  ...
  // state map is a storage for sticking in any info in the Trillo functions
  // The invoker will pass the state map to the subsequent calls of the Trillo functions
  // thus giving them capability to maintain some state information across calls.
  ...
  public Map<String, Object>toMap() {
    ...
    if (stateMap != null) m.put("stateMap", stateMap);
    return m;
  }
}
